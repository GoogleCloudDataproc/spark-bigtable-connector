...
class LessThanFilterAdapterTest extends AnyFunSuite {
  test("adaptLongValue") {
    val testData = Table(
      ("value", "valuesInRangeSet", "valuesOutsideRangeSet"),
      (
        10L,
        Array[Long](5L, 0L, -100L, Long.MinValue),
        Array[Long](10L, 3717458L, Long.MaxValue)
      ),
      (
        0L,
        Array[Long](-10L, -100L, Long.MinValue),
        Array[Long](0L, 5L, 101923L, Long.MaxValue)
      ),
      (
        -2503L,
        Array[Long](-3000L, Long.MinValue),
        Array[Long](-2503L, -1000L, 5L, 5000L, Long.MaxValue)
      ),
      (Long.MinValue, Array[Long](), Array[Long](Long.MinValue, -1000L))
    )
    forAll(testData) {
      (
          value: Long,
    ...
    forAll(testData) {
      (
        ...
        val utf8ResultRangeSet: RangeSet[RowKeyWrapper] =
          LessThanFilterAdapter.convertValueToRangeSet(
