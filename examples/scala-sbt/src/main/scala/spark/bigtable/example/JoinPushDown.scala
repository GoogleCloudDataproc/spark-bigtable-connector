...
object JoinPushDown extends App {
  ...
  val resDf2 = srcDf.joinWithBigtable(joinConfig, "word", Seq("word"))
  val resDf3 = srcDf.joinWithBigtable(joinConfig, "word", Array("word"))
  val resDf4 = srcDf.joinWithBigtable(joinConfig, "word", List("word"))
  val resDf5 = srcDf.as("a").joinWithBigtable(joinConfig, "word", col("a.word") === col("b.word"), joinType = "inner", aliasName = "b")
  val resDf6 = srcDf.as("a").joinWithBigtable(joinConfig, "word", expr("a.word = b.word"), aliasName = "b")
